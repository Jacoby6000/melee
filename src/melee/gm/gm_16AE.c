...
bool GetMatchTimer(int* arg0)
{
    if (arg0 != NULL && lbl_8046B6A0.x24C8.x0_6) {
        if (gm_8016B110()) {
            *arg0 = lbl_8046B6A0.x24C8.x10 - lbl_8046B6A0.timer_seconds;
        } else {
            *arg0 = lbl_8046B6A0.timer_seconds;
        }
        return true;
    }
    return false;
...
{
    return lbl_8046B6A0.FighterMatchInfo[arg0].x4_b3;
}
