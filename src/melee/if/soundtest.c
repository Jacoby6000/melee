...
bool un_80300968(bool update_scene)
{
    if (update_scene == true) {
        lbAudioAx_80024030(1);
        gm_RequestPendingGameMode(GM_HANYU_CSS);
        gm_801A4B60();
    }
...
bool un_803009A4(bool update_scene)
{
    if (update_scene == true) {
        lbAudioAx_80024030(1);
        gm_RequestPendingGameMode(GM_HANYU_SSS);
        gm_801A4B60();
    }
...
bool un_80300BBC(bool update_scene)
{
    if (update_scene == true) {
        Toy_803124BC();
        Toy_80311680();
        gm_RequestPendingGameMode(GM_TOY_GALLERY);
        gm_801A4B60();
    }
...
int fn_8030110C(int arg0)
{
    ...
    case 6:
        ...
        switch (un_804D6E00) {
        case 0:
            gm_RequestPendingGameMode(0x1A);
            gm_801BF040(0x15);
            break;
        case 1:
            gm_RequestPendingGameMode(0x1A);
...
void fn_803011EC(int arg0)
{
    ...
    case 6:
        ...
        gm_RequestPendingGameMode(0x15);
        gm_801A4B60();
        break;
    }
}
...
bool un_80301328(bool update_scene)
{
    if (update_scene == true) {
        lbAudioAx_80024030(1);
        gm_801BF708(0x0);
        gm_RequestPendingGameMode(GM_OPENING_MV);
        gm_801A4B60();
    }
...
bool un_803013B0(bool update_scene)
{
    if (update_scene == true) {
        lbAudioAx_80024030(1);
        gm_RequestPendingGameMode(GM_DEBUG_CUTSCENE);
        gm_801A4B60();
    }
...
bool un_803015BC(bool update_scene)
{
    if (update_scene == true) {
        lbAudioAx_80024030(1);
        gm_RequestPendingGameMode(GM_PROGRESSIVE_SCAN);
        gm_801A4B60();
    }
...
bool un_80301D40(bool update_scene)
{
    if (update_scene == true) {
        lbAudioAx_80024030(1);
        gm_RequestPendingGameMode(GM_FIXED_CAMERA_VS);
        gm_801A4B60();
    }
...
int un_80301D7C(int arg0)
{
    if (arg0 == 1) {
        ...
        gm_RequestPendingGameMode(0x2B);
        gm_801A4B60();
    }
    return 0;
}
