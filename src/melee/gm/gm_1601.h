...
/* 165E7C */ void gm_CalculateTeamScores(MatchEnd*);
/* 165FA4 */ MatchEnd* gm_CalculateTeamWinners(MatchEnd*);
/* 1661E0 */ MatchEnd* gm_CalculateTeamSmallLoser(MatchEnd*);
/* 166378 */ void gm_80166378(struct lbl_8046B6A0_24C_t*);
/* 166A98 */ MatchEnd* gm_80166A98(MatchEnd*, s32, s8, u8, s8, u8, s8, u8, u8,
                                   u8);
/* 166CBC */ s32 gm_IsSlotSmallLoser(MatchEnd*, ssize_t index);
/* 166CCC */ void gm_80166CCC(MatchEnd*, MatchEnd*);
/* 167140 */ bool gm_MatchHasWinner(MatchEnd*);
/* 167194 */ int gm_GetNumFFAMatchWinners(MatchEnd*);
...
/* 1677F8 */ bool gm_IsRumbleEnabled(int port, int);
